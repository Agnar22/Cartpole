...
The problem is easily solvable with q-learning, as demonstrated above. It needed about 3000 episodes to reach the final fitness where it _perfectly_ balances the pole in the middle of the screen.
